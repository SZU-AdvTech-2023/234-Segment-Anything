...
# from .DeSAM_mask_decoder import MaskDecoder
...
class Samus(nn.Module):
    ...
    def forward_sam(
        ...
        for image_record, curr_embedding in zip(batched_input, image_embeddings):
            ...
            # print("low_res_logits",low_res_masks.shape)
    ...
    def forward(
        ...
        if len(pt[0].shape) == 3:
          ...
          # print("low_mask", outputs['low_res_logits'].shape)
          return outputs
        else:
          low_res_masks, masks = [], []
          for i in range(pt[0].shape[1]):
            ...
            # print("low_res_masks",low_res_masksi.shape)
