...
class MaskDecoder(nn.Module):
    ...
    def forward(
        ...
        # Prepare output
        # print("masks_1",masks.shape)  # 4 1 128 128
    ...
    def predict_masks(
        ...
        # print(f"hs{hs.shape}\nsrc{src.shape}\n")  #hs(4,7,256)  src(4,1024,256)
        iou_token_out = hs[:, 0, :] # b c
        # print(f"iou_token_out{iou_token_out.shape}")  #(4,256)
        ...
        # print(f"masks{masks.shape}\niou_pred{iou_pred.shape}")  #masks(4,4,128,128) iou(4,4)
        return masks, iou_pred
